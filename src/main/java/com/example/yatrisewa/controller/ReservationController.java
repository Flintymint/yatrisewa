package com.example.yatrisewa.controller;

import com.example.yatrisewa.entities.Reservation;
import com.example.yatrisewa.models.ResponseModel;
...
public class ReservationController {
    ...
    @GetMapping("/query")
    public ResponseEntity<List<Reservation>> getAllReservationsByScheduleAndDepartureDate(
    ...
    public ResponseEntity<List<Reservation>> getAllReservationsByMobile(
